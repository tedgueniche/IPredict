...
public class ItemsetFinder {
	 ...
	 */
	public static List<List<Item>> findFrequentItemsets(List<Sequence> seqs, int minLength, int maxlength, int minSup) {
...
//		training.add(seq4);
		...
		System.out.println(findFrequentItemsets(training,2,4,2));
	}
