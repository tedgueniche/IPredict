...
public class BinaryCTWPredictorVMM implements Predictor{
	
	BinaryCTWPredictor predictor;
	...
	public BinaryCTWPredictorVMM(int abSize, int vmmOrder){
		predictor = new BinaryCTWPredictor();
		this.abSize = abSize;
...
//			double prediction = predictor.predict(intToChar(item), testSeq.toString().substring(test.size() - antecedentSize -1));
